...
function M.set_options(new_opts)
	local opts = vim.g.daydream_opts
	vim.g.daydream_opts = vim.tbl_deep_extend("force", opts, new_opts)

	return vim.g.daydream_opts
end
